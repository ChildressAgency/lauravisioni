...
*/
jQuery(document).ready(function(a){a("#gallery-modal").on("shown.bs.modal",function(e){var t=e.relatedTarget,i=a(t).data("initial_slide"),s=new Swiper("#gallery-modal .swiper-container",{navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},autoHeight:!0,effect:"fade",autoplay:!1,spaceBetween:35,preloadImages:!0,loop:!0});s.slideTo(i+1),s.update()}),a("#portfolio-gallery .gallery-item").on("click",function(e){e.preventDefault()})});
